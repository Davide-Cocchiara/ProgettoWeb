...
<head>
    ...
    <title>Errore del server - Servizi Sanitari per il cittadino</title>
            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="text-center mt-5">
                        <div class="d-xl-flex error mx-auto" data-text="Errore" style="width: 291px;">
                            <p class="d-xl-flex justify-content-xl-center m-0">Errore</p>
                        </div>
                        <p class="text-dark mb-5 lead">Qualcosa è andato storto</p><a href="<%=request.getContextPath()%>/">Torna alla home</a></div>
                </div>
            </div>
