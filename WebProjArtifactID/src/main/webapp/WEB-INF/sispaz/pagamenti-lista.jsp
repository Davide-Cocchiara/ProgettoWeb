                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                <thead>
                                    <tr>
                                        <th style="width: 144px;">Data Emissione</th>
                                        <th>Prestazione</th>
                                        <th>Costo</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>123,3€</td>
                                        <td style="color: rgb(231,103,94);"><strong>Non&nbsp;Pagato</strong></td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td><strong>Data Emissione</strong><br></td>
                                        <td><strong>Prestazione</strong></td>
                                        <td><strong>Costo</strong></td>
                                        <td><strong>Data Pagamento</strong><br></td>
