        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div class="col-lg-4">
                        <div class="card mb-3">
                            <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="<%=request.getContextPath()%>/sismed/paziente/fotopaziente" width="160" height="160">
                                <div class="mb-3"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group"><label for="first_name"><strong>Data di nascita</strong></label><input class="form-control" type="text" placeholder="0/0/0000" name="nascita" value="${sessionScope.selectedpaziente.getDatanascita()}" readonly=""></div>
                                        </div>
                                        <div class="col">
