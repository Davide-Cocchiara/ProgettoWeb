            ...
            <div class="container-fluid">
                <div>
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" role="tab" data-toggle="tab" href="#tab-1">Esame
                            Specialistico</a></li>
                        <li class="nav-item"><a class="nav-link" role="tab" data-toggle="tab" href="#tab-2">Esame
                            di Laboratorio</a></li>
                        <li class="nav-item"><a class="nav-link" role="tab" data-toggle="tab" href="#tab-3">Ricetta
                            Farmaco</a></li>
                    </ul>
                        ...
                        <div class="tab-pane active" role="tabpanel" id="tab-1">
                            <div class="card shadow">
                                ...
                                <div class="card-body"><span class="d-inline-flex d-lg-inline mr-2 text-gray-600 small"
                                        ...
                                        style="font-size: 20px;"><%= LocalDate.now().toString()%></span></div>
                                <form action="<%=request.getContextPath()%>/sismed/paziente/eroganuovaricetta"
                                      method="post">
                                    <div class="card-body"><span
                                            class="d-inline-flex d-lg-inline mr-2 text-gray-600 small"
                                            style="font-size: 20px;"><strong>Esame Specialistico Prescritto</strong></span>

                                        <select class="form-control border rounded float-right" name="selectedesame">
                                            <optgroup label="Esami Specialistici">
                                                ${requestScope.esamespecdropdown}
                        ...
                        <div class="tab-pane" role="tabpanel" id="tab-2">
                            <div class="card shadow">
                                ...
                                <form action="<%=request.getContextPath()%>/sismed/paziente/eroganuovaricetta"
                                    ...
                                    <div class="card-body"><span
                                            class="d-inline-flex d-lg-inline mr-2 text-gray-600 small"
                                            style="font-size: 20px;"><strong>Esame di Laboratorio Prescritto</strong></span>

                                        <select class="form-control" name="selectedesame">
                                            <optgroup label="Esame di Laboratorio">
                                                ${requestScope.esamelabdropdown}
                        ...
                        <div class="tab-pane" role="tabpanel" id="tab-3">
                            <div class="card shadow">
                                ...
                                <form action="<%=request.getContextPath()%>/sismed/paziente/eroganuovaricetta"
                                    ...
                                    <div class="card-body"><span
                                            class="d-inline-flex d-lg-inline mr-2 text-gray-600 small"
                                            style="font-size: 20px;"><strong>Farmaco Prescritto</strong></span>
