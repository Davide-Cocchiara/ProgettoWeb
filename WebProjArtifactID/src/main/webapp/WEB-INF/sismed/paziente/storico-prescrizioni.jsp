...
<head>
    ...
    <title>Storico Prescrizioni - Servizi Sanitari per il cittadino</title>
...
<body id="page-top">
    ...
    <script>
        $( document ).ready(function() {
            tables_listaprescrizioni("#prescrizioni","<%=request.getContextPath()%>/sismed/paziente/getprescrizioni","<%=request.getContextPath()%>/sismed/paziente/storicoprescrizionesingola?idprescrizione=");
        });
    </script>
