...
@WebServlet("/sismed/paziente/storicoprescrizionesingola")
public class StoricoPrescrizioneSingola extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (error) {
            ...
            if (prescrizione != null) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/sismed/paziente/storico-prescrizione-singola.jsp");
                rd.forward(request,response);
            }
            else {
                RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/error.jsp");
