...
@WebServlet("/sissan/getesamispecdisponibili")
public class GetEsamiSpecialisticiDisponibili extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Map.Entry<String, Map.Entry<String, String>>> listaEsamiDisponibili = prov.getListaEsamiDisponibili(false);

        Gson gson = new GsonBuilder().setPrettyPrinting().setDateFormat("yyyy/MM/dd").create();
        String json = "{ \"content\": " + gson.toJson(listaEsamiDisponibili) + "}";
